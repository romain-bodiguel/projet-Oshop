...
<section class="hero">
  ...
  <section class="products-grid">
    <div class="container-fluid">
      ...
      <div class="row">
        <!-- product-->
        <?php foreach ($brandArray as $id => $currentBrand) : ?>
        <div class="product col-xl-3 col-lg-4 col-sm-6">
          <div class="product-image">
            <a href="detail.html" class="product-hover-overlay-link">
              <img src="<?= $_SERVER['BASE_URI'] ?>/<?= $brandArray[$id]['picture'];?>" alt="product" class="img-fluid">
            </a>
          </div>
          ...
          <div class="py-2">
            <p class="text-muted text-sm mb-1"><?= $brandArray[$id]['brand_name'];?></p>
            <h3 class="h6 text-uppercase mb-1"><a href="detail.html" class="text-dark"><?= $brandArray[$id]['name'];?></a></h3><span class="text-muted"><?= $brandArray[$id]['price'];?> €</span>
          </div>
        </div>
        <?php endforeach; ?>
        <!-- /product-->
