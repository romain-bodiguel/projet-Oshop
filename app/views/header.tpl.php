      ...
      <div class="container-fluid">
        ...
        <div id="navbarCollapse" class="collapse navbar-collapse">
          <ul class="navbar-nav mx-auto">
            ...
            <li class="nav-item">
              <a href="<?= $_SERVER['BASE_URI'] ?>/catalogue/categorie/3" class="nav-link">Catégorie 3</a>
            </li>
            <li class="nav-item">
              <a href="<?= $_SERVER['BASE_URI'] ?>/catalogue/type/5" class="nav-link">Types de produit 5</a>
            </li>
            <li class="nav-item">
              <a href="<?= $_SERVER['BASE_URI'] ?>/catalogue/marque/2" class="nav-link">Marque 2</a>
            </li>
            <li class="nav-item">
              <a href="<?= $_SERVER['BASE_URI'] ?>/catalogue/produit/1" class="nav-link">Produit 1</a>
            </li>
            <li class="nav-item">
              <a href="<?= $_SERVER['BASE_URI'] ?>/mentions-legales" class="nav-link">Mentions légales</a>
            </li>
          </ul>
          <div class="d-flex align-items-center justify-content-between justify-content-lg-end mt-1 mb-2 my-lg-0">
            ...
            <div class="nav-item dropdown">
              <a href="<?= $_SERVER['BASE_URI'] ?>/cart" class="navbar-icon-link d-lg-none">
                  <span class="badge badge-secondary">New</span>
              </a>
              <div class="d-none d-lg-block">
                <a id="cartdetails" data-toggle="dropdown" aria-haspopup="true"
                aria-expanded="false" href="<?= $_SERVER['BASE_URI'] ?>/cart" class="navbar-icon-link dropdown-toggle">
                ...
                <div aria-labelledby="cartdetails" class="dropdown-menu dropdown-menu-right p-4">
                  <div class="navbar-cart-product-wrapper">
                    ...
                    <div class="d-flex justify-content-between">
                      <a href="<?= $_SERVER['BASE_URI'] ?>/cart" class="btn btn-link text-dark mr-3">Voir le panier <i class="fa-arrow-right fa"></i></a>
                      <a href="<?= $_SERVER['BASE_URI'] ?>/cart" class="btn btn-outline-dark">Commander</a>
                    </div>
                  </div>
                </div>
              </div>
